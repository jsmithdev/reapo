...
<div class="container">
    ...
    <svg class="alpha hide" title="Sort Alphabetically" viewBox="0 0 24 24">
    ...
    <svg class="numeric" title="Sort Modified Date" viewBox="0 0 24 24">
...
export class SortDir extends HTMLElement {
    ...
    registerElements(){
        ...
        this.dom = {
            alpha: this.shadowRoot.querySelector('.alpha'),
            numeric: this.shadowRoot.querySelector('.numeric'),
        }
