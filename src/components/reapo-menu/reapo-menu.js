...
export class ReapoMenu extends HTMLElement {
	...
	registerElements() {
		...
		this.dom = {
			...
			settings: this.shadowRoot.querySelector('reapo-settings'),
		}
	...
	registerListeners() {
		...
		/* Opener */
		this.dom.menu.onclick = () => {
			this.dom.settings.open()
		}

		/* Save Main Settings */
		this.dom.settings.addEventListener('save-settings', (e) => {
		...
		/* New blank Repo */
		this.dom.settings.addEventListener('new-repo', newRepo)


		/* New git clone */
		this.dom.settings.addEventListener('new-git', (e) => execEvent(e))

		/* New sfdx project */
		this.dom.settings.addEventListener('new-sfdx', e => execEvent(e))
